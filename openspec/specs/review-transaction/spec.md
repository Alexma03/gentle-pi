...
- GIVEN Pi negotiates against the pinned v2.2.3 provider
...
- GIVEN `.gentle-ai/` holds only pre-v2.2.3 runtimes
- WHEN Pi resolves the pinned executable
- THEN negotiation fails hard, naming the expected v2.2.3 version, rather than degrading to an older runtime
